...
CREATE DATABASE [PartitioningDemo]
 ON PRIMARY 
	(NAME = N'PartitionDemo', FILENAME = '/var/opt/mssql/data/PartitionDemo.mdf'), 
	 FILEGROUP [DATA1] 
	(NAME = N'DATA1', FILENAME = '/var/opt/mssql/data/DATA1.ndf'),
	 FILEGROUP [DATA2] 
	(NAME = N'DATA2', FILENAME = '/var/opt/mssql/data/DATA2.ndf'),
	 FILEGROUP [DATA3] 
	(NAME = N'DATA3', FILENAME = '/var/opt/mssql/data/DATA3.ndf'),
	 FILEGROUP [DATA4] 
	(NAME = N'DATA4', FILENAME = '/var/opt/mssql/data/DATA4.ndf'),
	 FILEGROUP [DATA5] 
	(NAME = N'DATA5', FILENAME = '/var/opt/mssql/data/DATA5.ndf'),
	 FILEGROUP [DATA6] 
	(NAME = N'DATA6', FILENAME = '/var/opt/mssql/data/DATA6.ndf'),
	 FILEGROUP [DATA7] 
	(NAME = N'DATA7', FILENAME = '/var/opt/mssql/data/DATA7.ndf'),
	 FILEGROUP [DATA8] 
	(NAME = N'DATA8', FILENAME = '/var/opt/mssql/data/DATA8.ndf'),
	 FILEGROUP [DATA9] 
	(NAME = N'DATA9', FILENAME = '/var/opt/mssql/data/DATA9.ndf'),
	 FILEGROUP [DATA10] 
	(NAME = N'DATA10', FILENAME = '/var/opt/mssql/data/DATA10.ndf'),
	 FILEGROUP [DATA11] 
	(NAME = N'DATA11', FILENAME = '/var/opt/mssql/data/DATA11.ndf'),
	 FILEGROUP [DATA12] 
	(NAME = N'DATA12', FILENAME = '/var/opt/mssql/data/DATA12.ndf')
 LOG ON 
	(NAME = N'PartitionDemo_log', FILENAME = N'/var/opt/mssql/data/PartitionDemo_log.ldf')
GO
